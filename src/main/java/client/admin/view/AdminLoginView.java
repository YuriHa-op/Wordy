...
public class AdminLoginView extends JFrame {
    ...
    private final JButton loginButton = new StyledButton("ENTER CONSOLE");
    ...
    public AdminLoginView() {
        ...
        StyledPanel background = new StyledPanel("/textures/admin_login.png", 45);
        background.setLayout(new GridBagLayout());

        JPanel card = new JPanel(new GridBagLayout());
        card.setOpaque(true);
        card.setBackground(new Color(80, 0, 0));
        ...
        JLabel title = new JLabel("ADMIN CONSOLE", SwingConstants.CENTER);
        title.setFont(UiFonts.LARGE);
        title.setForeground(UiColors.TEXT_RED);
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.gridwidth = 2;
        card.add(title, gbc);
